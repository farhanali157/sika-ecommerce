    ...
    <footer className="bg-amber-500 text-gray-950 border-t border-amber-600">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <p className="text-sm text-gray-900 max-w-sm font-medium">
              Global leader in specialty chemicals for construction and
              industry.
            </p>
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <ul className="space-y-3 text-sm font-medium">
              <li className="flex items-start space-x-3">
                ...
                <span>
                  First Floor 141-CCA, Phase IV DHA, 54792 Lahore, Pakistan
                </span>
              </li>
              ...
              <li className="flex items-center space-x-3">
                <svg
                  className="h-4 w-4 text-red-600 fill-current shrink-0"
                  viewBox="0 0 24 24"
                >
            ...
            <div className="flex items-center space-x-3 pt-2">
              {/* Facebook */}
              <a
                href="https://www.facebook.com/SikaPakistan.Pvt"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 rounded-full bg-gray-950 text-white hover:bg-red-600 transition-colors"
              >
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/sikapakistan"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 rounded-full bg-gray-950 text-white hover:bg-red-600 transition-colors"
              >
              ...
              {/* YouTube */}
              <a
                href="https://www.youtube.com/channel/UCVTbfu_ZZbmn3dSeEOM4V_A"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 rounded-full bg-gray-950 text-white hover:bg-red-600 transition-colors"
              >
        ...
        <div className="mt-12 border-t border-amber-600/40 pt-8 flex flex-col sm:flex-row justify-between items-center text-xs text-gray-900 font-medium">
          <p>
            &copy; {new Date().getFullYear()} Sika Pakistan (Pvt) Ltd. All
            rights reserved.
          </p>
