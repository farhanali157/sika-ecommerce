      ...
      <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm flex items-center justify-between">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-black text-gray-900">Admin Portal Protected Area</h1>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">
              Inspect direct purchases, update fulfillment status (PENDING $\rightarrow$ DELIVERED), and snapshot line items.
            </p>
          </div>
        </Link>
        ...
        <div className="bg-gray-50 p-6 rounded-2xl border border-gray-200/70 opacity-75 space-y-4">
          ...
          <div>
            <h2 className="text-base font-bold text-gray-700">B2B Wholesale Accounts</h2>
            <p className="text-xs text-gray-400 mt-1">
              Review pending B2B distributor applications and verify tax registration status.
            </p>
          </div>
        </div>
      </div>
